        ...
        <Card className="shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 border-0 bg-gradient-to-br from-accent/5 to-secondary/10">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-3xl font-bold text-accent">{photographer?.rating || "4.8"}</p>
              ...
              photographerBookings.slice(0, 3).map((booking) => (
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-sm font-semibold mt-1">{booking.totalAmount.toLocaleString()} DA</p>
                  </div>
                </div>
              ))
            ) : (
            ...
            {recentMessages.length > 0 ? (
              recentMessages.map((message) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-semibold text-sm">Client Inquiry</p>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-6 border rounded-xl hover:shadow-md transition-all duration-200 bg-gradient-to-br from-accent/5 to-secondary/10">
              ...
              <span className="text-3xl font-bold text-accent">89</span>
              <p className="text-sm text-muted-foreground font-medium mt-2">New Inquiries</p>
